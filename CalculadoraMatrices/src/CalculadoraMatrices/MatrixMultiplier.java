...
// recuerda poner el paquete al que le corresponde y añadir los ficheros en la misma carpeta del código
...
public class MatrixMultiplier {
    ...
    public static int[][] multiply(int[][] matrix1, int[][] matrix2, int rows1, int cols1, int cols2) {
    ...
    public static void writeMatrixToFile(String file, int[][] matrix) {
    ...
    public static void main(String[] args) {
        String file1 = "matrix1";
        String file2 = "matrix2";
